        ...
        <div className="post">
            <div className="post-text-header">
                ...
                {sessionUser && !isOwner && !isFollowing && (
                    <p className="post-text-follow-button">
                        follow button goes here
                    </p>
                )}                
                <p className="post-text-options-button">
            ...
            <div className="post-text-footer">
                <p className="post-text-notes">
                    notes count
                </p>
                <p className="post-text-reply">
                    reply button
                </p>
                
                <p className="post-text-like">
                    like button
                </p>
            </div>
        </div>
    ...
    return (
        ...
        <div className="post">
            ...
            <div className="post-image-main-body">
                <p className="post-image-picture">
                    picture goes here
                </p>
                <p className="post-image-body">
                    body goes here
                </p>
            ...
            <div className="post-image-footer">
                <p className="post-image-notes">
                    notes count
                </p>
                <p className="post-image-reply">
                    reply button
                </p>
                
                <p className="post-image-like">
                    like button
                </p>
            </div>
        </div>
    ...
    return (
        ...
        <div className="post">
            ...
            <div className="post-quote-main-body">
                <h1 className="post-quote-title">
                    quote goes here
                </h1>
                <p className="post-quote-body">
                    body or author goes here
                </p>
                <p className="post-quote-tags">
                    tags go here
                </p>
            </div>
            {isOwner && (
            ...
            <div className="post-quote-footer">
                <p className="post-quote-notes">
                    notes count
                </p>
                <p className="post-quote-reply">
                    reply button
                </p>
                
                <p className="post-quote-like">
                    like button
                </p>
            </div>
        </div>
    ...
    return (
        ...
        <div className="post">
            <div className="post-link-header">
                ...
                {sessionUser && !isOwner && !isFollowing && (
                    <p className="post-link-follow-button">
                        follow button goes here
                    </p>
                )}                
                <p className="post-link-options-button">
                    options button goes here
                </p>
            </div>
            <hr />
            <div className="post-link-main-body">
                <p className="post-link-display">
                    display of website goes here
                </p>
                <p className="post-link-body">
                    body goes here
                </p>
                <p className="post-link-tags">
                    tags go here
                </p>
            </div>
            {isOwner && (
            ...
            <div className="post-link-footer">
                <p className="post-link-notes">
                    notes count
                </p>
                <p className="post-link-reply">
                    reply button
                </p>
                
                <p className="post-link-like">
                    like button
                </p>
            </div>
        </div>
